  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        const errorMessage =
          errorData.message || 'Ocurrió un error al guardar.';
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              accept="image/*"
              className={`${inputStyle} file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-purple-50 file:text-purple-700 hover:file:bg-purple-100`}
            />
            {fotoPreview && (
              <div className="mt-4">
                <img
                  src={fotoPreview}
                  alt="Vista previa de la sucursal"
          ...
          <div>
            ...
            <select
              name="habilitado"
              id="habilitado"
              value={Number(sucursal.habilitado)}
              onChange={handleInputChange}
              className={inputStyle}
            >
